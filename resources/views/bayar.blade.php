    ...
    <div class="col-lg-6 col-md-8">
        <div class="card p-5 shadow border-0 text-center" style="border-radius: 1.5rem; background: rgba(255,255,255,0.95);">
            ...
            <div class="alert alert-warning rounded-4 border-0 mb-4 p-4">
                ...
                <h2 class="fw-bold text-dark m-0">Rp {{ number_format($peserta->total_bayar, 0, ',', '.') }}</h2>
            </div>
            ...
            <div class="card border-2 rounded-4 p-4 mb-4" style="border-style: dashed !important; border-color: #ff9800 !important; background-color: #fff9f0;">
                @if($peserta->metode_pembayaran == 'BCA')
                ...
                @else
                    ...
                    <div class="mb-3">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=Payment-For-Ticket-{{ $peserta->tiket_id }}" alt="QRIS Dummy" class="img-fluid rounded shadow-sm border p-2 bg-white">
                    </div>
            ...
            <div class="bg-light p-3 rounded-4 text-start mb-4">
                ...
                <ol class="small text-muted mb-0 ps-3">
                    ...
                    <li>Tiket ID Anda: <strong>#{{ $peserta->tiket_id }}</strong> (Tunjukkan saat konfirmasi).</li>
                </ol>
            </div>
