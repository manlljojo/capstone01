    ...
    <div class="container py-5 px-lg-5">
        ...
        <div class="row g-4 justify-content-center">
            @forelse($events as $event)
                        ...
                        <div class="card-body p-4 d-flex flex-column">
                            <div class="d-flex align-items-center mb-3">
                                <span class="badge bg-primary px-3 py-2 rounded-pill shadow-sm">
                                    <i class="fa fa-calendar-alt me-1"></i> {{ \Carbon\Carbon::parse($event->tanggal_event)->format('d M Y') }}
                                </span>
                            ...
                            @if($event->kuota > 0)
                                <a href="/tiket/{{ $event->id_event }}" class="btn btn-primary w-100 rounded-pill py-2 fw-bold mb-3">
                ...
                <div class="modal fade" id="modal-{{ $event->id_event }}" tabindex="-1" aria-hidden="true">
