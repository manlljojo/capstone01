                        ...
                        <tbody>
                            ...
                            <tr class="border-bottom">
                                ...
                                <td>
                                 ...
                                 <td class="text-muted small"><i class="fa fa-calendar-alt text-rose me-1"></i> {{ \Carbon\Carbon::parse($event->tanggal)->format('d M Y') }} <br> <i class="fa fa-map-marker-alt text-rose me-1"></i> {{ $event->lokasi }}</td>
                                <td>
