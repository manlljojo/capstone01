...
<head>
    <meta charset="utf-8">
    <title>Konser Kita | @yield('title')</title>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        @php
                            ...
                            $user = Auth::guard('admin')->user() ?? Auth::guard('penyelenggara')->user() ?? Auth::guard('pengguna')->user();
                        @endphp

                        @if($isAdmin || $isPengguna || $isPenyelenggara)
                            @if($isAdmin)
                            ...
                            @elseif($isPenyelenggara)
                                <a href="/admin" class="nav-item nav-link">Panel Penyelenggara</a>
                            @else
                ...
                <div class="container px-lg-5">
                    ...
                    <div class="row g-5 align-items-end">
                        <div class="col-lg-6 text-center text-lg-start">
                            @if($isAdmin || $isPenyelenggara || $isPengguna)
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">Konser Kita Portal</a>, All Right Reserved. 
