...
<head>
    ...
    <title>Tiket Elektronik - {{ $peserta->detailPemesanans->first()->tiket->event->nama_event ?? '-' }}</title>
    <!-- Google Fonts -->
    ...
    <div class="container">
        ...
        <div class="event-info">
            <div class="event-title">
                @php
                    $event = $peserta->detailPemesanans->first()->tiket->event ?? null;
                @endphp
                ...
                <div class="event-detail">
                    <i class="fa fa-user"></i> <span>Pemilik: <strong>{{ $peserta->nama_pemesan ?? ($peserta->pengguna->nama ?? '-') }}</strong></span>
                </div>
                <div class="event-detail">
                    <i class="fa fa-calendar-alt"></i> <span>Tanggal: {{ \Carbon\Carbon::parse($event->tanggal_event ?? now())->format('d F Y') }}</span>
                </div>
                <div class="event-detail">
                    <i class="fa fa-map-marker-alt"></i> <span>Lokasi: {{ $event->lokasi ?? '-' }}</span>
                </div>
                <div class="event-detail">
                    <i class="fa fa-clock"></i> <span>Waktu: {{ $event->jam_operasional ?? '-' }}</span>
                </div>
            </div>
        ...
        <div class="restriction-box">
            ...
            <div class="restriction-grid">
                <div class="restriction-item">
                    ...
                    Maks. {{ $event->kapasitas ?? 'N/A' }} Orang
                </div>
                <div class="restriction-item">
